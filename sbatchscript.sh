#!/bin/bash
#SBATCH --job-name=pos_comb
#SBATCH --ntasks=1 --cpus-per-task=5 --mem=95G
...
python train.py --dataset SUBJ --max_sequence_length 50 --cus_pos n --k_roles 4 --search_times 20
...
python train.py --dataset TREC --max_sequence_length 60 --cus_pos n --k_roles 4 --search_times 20
...
# python train_large.py --dataset YELP --max_sequence_length 150 --cus_pos a --k_roles 5 --search_times 10 --tag_encoding 0
# python train.py --dataset YELP --max_sequence_length 150 --cus_pos a --k_roles 4
...
# python train.py --dataset IMDB --max_sequence_length 270 --cus_pos a --k_roles 4 --search_times 8
...
python train.py --dataset SST --max_sequence_length 50 --cus_pos a --k_roles 4 --search_times 11 --tag_encoding 0

# python train.py --dataset MR --max_sequence_length 50 --cus_pos a --k_roles 5 --search_times 15
# python train.py --dataset MR --max_sequence_length 50 --cus_pos a --k_roles 4 --search_times 20
...
# python train.py --dataset ROTTENTOMATOES --max_sequence_length 90 --cus_pos a --k_roles 4 --search_times 20
...
# python train.py --dataset DBPEDIA --max_sequence_length 50 --cus_pos n --k_roles 4 --search_times 10
